...
TEST(FilterSS2Test, Tustin2TF00) {
    ...
    Eigen::Vector3f num_s(0,0,1);
    Eigen::Vector3f den_s(0,10,1);
...
TEST(FilterSS2Test, Tustin2TF01) {

    Eigen::Vector3f num_s(0,0,4.0);
    Eigen::Vector3f den_s(1.0,2*1.0/sqrt(2)*2.0,4.0);
